...
interface ButtonProps {
  ...
  disabled?: boolean;
  loading?: boolean;
  icon?: 'download' | 'upload' | 'refresh' | 'settings';
}
...
export const Button = ({
  ...
  const colorStyles = primary
    ? `text-white ${disabled ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'}`
    : `text-gray-700 ${disabled ? 'bg-gray-300' : 'bg-gray-100 hover:bg-gray-200'}`;
